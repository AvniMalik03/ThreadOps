  ...
  return (
    <main className="p-6 md:p-8 max-w-6xl mx-auto w-full">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href={`/dashboard/orders/${id}/audit`}
          className="inline-flex items-center gap-2 rounded-md bg-white px-3 py-2 text-sm font-semibold text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 hover:bg-neutral-50 dark:bg-neutral-800 dark:text-white dark:ring-neutral-700 dark:hover:bg-neutral-700 transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
